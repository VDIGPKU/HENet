...
import mmcv
from data_converter import nuscenes_converter_R_10frame as nuscenes_converter
...
if __name__ == '__main__':
    ...
    # nuScenes 1.0 train, val, test
    dataset = 'nuscenes'
    version = 'v1.0'
    train_version = f'{version}-trainval'
    root_path = './data/nuscenes'
    extra_tag = 'nuscenes_LRC'
    nuscenes_data_prep(
        root_path=root_path,
    ...
    # root_path = './data/nuscenes'
    # create_groundtruth_database('NuScenesDataset_LRC', root_path, 'nuscenes_LRC',
    #                             'data/nuscenes/nuscenes_LRC_infos_train.pkl')

    # trainval union for test sub
    dataset = 'nuscenes'
    version = 'v1.0'
    train_version = f'{version}-trainval-union'
    root_path = './data/nuscenes'
    extra_tag = 'nuscenes_LRC_trainval' #nuscenes_R
    nuscenes_data_prep(
        root_path=root_path,
        info_prefix=extra_tag,
        version=train_version,
    ...
    # root_path = './data/nuscenes'
    # create_groundtruth_database('NuScenesDataset_LRC', root_path, 'nuscenes_LRC_trainval',
    #                             'data/nuscenes/nuscenes_LRC_trainval_infos_train.pkl')
