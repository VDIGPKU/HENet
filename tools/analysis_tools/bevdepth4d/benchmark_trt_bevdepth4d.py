'''
PYTHONPATH='.' python ./tools/analysis_tools/bevdepth4d/benchmark_trt_bevdepth4d.py \
...
mmdeploy/tensorrt8522/detsegVAD-256x704-r50-BEV128-9kf-depth-circle60ev4/bevdepth4d_int8_fuse.engine \
--hyper_data_path mmdeploy/tensorrt8522/detsegVAD-256x704-r50-BEV128-9kf-depth-circle60ev4/bevdepth4d_hyper_data_fuse.pkl \
...
def main():
    ...
    for i, data in enumerate(data_loader):
        ...
        #     interval_lengths = []
            ...
            imgs = pickle.load(open('mmdeploy/changan_centerpoint/backbone_fp16_data.pkl', 'rb'))
            imgs = imgs['img'][0][0].cuda()
            # imgs = torch.rand(6, 3, 448, 576).cuda()
            trt_output = trt_model.forward(dict(imgs=imgs))
            output = model(imgs=imgs, **metas)
            ...
            if args.postprocessing:
                ...
                pred = model.result_deserialize(trt_output + [None])
