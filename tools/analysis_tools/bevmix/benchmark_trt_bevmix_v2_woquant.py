'''
PYTHONPATH='.' python ./tools/analysis_tools/benchmark_trt_bevmix_v2_woquant.py \
configs/bevmix/detsegVAD-640x1152-vov99+r50-BEV256+128-2+9kf-stereo-circle60e-loaddet-segupupper.py \
work_dirs/multitask_v2640+r50256_nds59.9_seg58.0.pth \
mmdeploy/detsegVAD-640x1152-vov99+r50-BEV256+128-2+9kf-stereo-circle60e-loaddet-segupupper-woquant \
bevmix_sim.engine \
