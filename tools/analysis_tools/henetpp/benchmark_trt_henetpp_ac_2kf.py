...
'''
henetpp_bev:
PYTHONPATH='.' python ./tools/analysis_tools/henetpp/benchmark_trt_henetpp_ac_2kf.py \
configs/henetpp/changan_rc_multitask_small_res_deploy_2kf.py \
...
def main():
    ...
    with torch.no_grad():
        for i, data in enumerate(data_loader):
            ...
            mlp_input = torch.cat((mlp_input, mlp_input_perv)).unsqueeze(0)
