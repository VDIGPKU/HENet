...
class SparseBEVTransformer_rc_v2(BaseModule):
    def __init__(self, embed_dims, num_frames=8, num_points=4, num_layers=6, num_levels=4, num_classes=10, code_size=10, pc_range=[], init_cfg=None):
        ...
        super(SparseBEVTransformer_rc_v2, self).__init__(init_cfg=init_cfg)
...
class SparseBEVSampling(BaseModule):
    ...
    def __init__(self, embed_dims=256, num_frames=4, num_groups=4, num_points=8, num_levels=4, pc_range=[], init_cfg=None, radar_dim=96):
        super().__init__(init_cfg)
