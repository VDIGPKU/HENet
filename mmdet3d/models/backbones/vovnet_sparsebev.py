...
class VoVNet_s(BaseModule):
    def __init__(self, spec_name, input_ch=3, out_features=None, frozen_stages=-1, norm_eval=True, with_cp=False,
                 pretrained=None, init_cfg=None, return_list=False):
        """
        Args:
        ...
        """
        super(VoVNet_s, self).__init__(init_cfg)
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(VoVNet_s, self).train(mode)
        self._freeze_stages()
