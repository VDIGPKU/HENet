...
def generate_rays_nframe(coors, label_depths, label_segs, c2w, intrins, max_ray_nums=0, time_ids=None, dynamic_class=None, balance_weight=None, weight_adj=0.3, weight_dyn=0.0, use_wrs=True):
    all_rays=[]
    for time_id in time_ids:    # multi frames
        # generate rays
        rays = []
