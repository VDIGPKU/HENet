...
from mmdet3d.datasets.map_utils.struct import LiDARInstanceLines
...
# from mmdet3d.datasets.map_utils.mean_ap import eval_map
from mmdet3d.datasets.map_utils.mean_ap import format_res_gt_by_classes
...
class B2D_VAD_Dataset(Custom3DDataset):
    ...
    def __init__(self, queue_length=4, bev_size=(200, 200),overlap_test=False,with_velocity=True,sample_interval=5,name_mapping=NameMapping,eval_cfg = None, map_root =None,map_file=None,past_frames=2, future_frames=6,point_cloud_range = [-51.2, -51.2, -5.0, 51.2, 51.2, 3.0] ,polyline_points_num=20, multi_adj_frame_id_cfg = None,*args, **kwargs):
