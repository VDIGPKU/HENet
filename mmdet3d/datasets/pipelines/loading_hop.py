...
class hop_LoadMultiViewImageFromFiles(object):
...
@PIPELINES.register_module()
class hop_LoadImageFromFileMono3D(LoadImageFromFile):
...
@PIPELINES.register_module()
class hop_LoadPointsFromMultiSweeps(object):
...
@PIPELINES.register_module()
class hop_PointSegClassMapping(object):
...
@PIPELINES.register_module()
class hop_NormalizePointsColor(object):
...
@PIPELINES.register_module()
class hop_LoadPointsFromFile(object):
...
@PIPELINES.register_module()
class hop_LoadPointsFromDict(hop_LoadPointsFromFile):
...
@PIPELINES.register_module()
class hop_LoadAnnotations3D(LoadAnnotations):
    """Load Annotations3D.
...
@PIPELINES.register_module()
class hop_PointToMultiViewDepth(object):
...
@PIPELINES.register_module()
class hop_PrepareImageInputs(object):
    """Load multi channel images from a list of separate channel files.
...
@PIPELINES.register_module()
class hop_LoadAnnotationsBEVDepth(object):
