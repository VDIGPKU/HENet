...
# Optimizer
optimizer = dict(type='AdamW', lr=0., weight_decay=0.0, betas=(0.999, 0.999),) #小10倍
...
load_from='work_dirs/det-256x704-r50-BEV180-9kf-depth-bevfusion-lc-transfusion-upsample-pretrain/epoch_20.pth'
