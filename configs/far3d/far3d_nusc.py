...
custom_hooks = [dict(type='UseGtDepthHook', stop_gt_depth_iter=12000)]
load_from='ckpts/cascade_mask_rcnn_r101_fpn_coco20epoch_nuim_20epoch-remapped.pth'
resume_from=None
