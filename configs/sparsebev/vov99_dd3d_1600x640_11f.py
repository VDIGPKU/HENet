...
train_pipeline = [
    ...
    dict(type='LoadMultiViewImageFromMultiSweeps', sweeps_num=10),
...
test_pipeline = [
    dict(type='LoadMultiViewImageFromFiles', to_float32=False, color_type='color'),
    dict(type='LoadMultiViewImageFromMultiSweeps', sweeps_num=10, test_mode=True),
...
load_from = 'work_dirs/sparsebev_vov99_8f_651.pth'
load_img_backbone_from = None
