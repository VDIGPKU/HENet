...
img_backbone = dict(
    ...
    fpn_norm="LN",
    fpn_square_pad=1600,
    # pretrained='work_dirs/eva02_L_coco_seg_sys_o365.pth',
    pretrained=None,
    frozen_blocks=3,
)
img_norm_cfg = dict(
...
data = dict(
    ...
    val=dict(
        ann_file='data/nuscenes/nuscenes_infos_test_sweep.pkl',
        pipeline=test_pipeline),
    test=dict(
        ann_file='data/nuscenes/nuscenes_infos_test_sweep.pkl',  # use nuscenes_infos_test_sweep.pkl for submission
        pipeline=test_pipeline)
)
