'''
pts_bbox_NuScenes/NDS: 0.6298
pts_bbox_NuScenes/mAP: 0.5466
'''
...
train_pipeline = [
    ...
    dict(type='LoadMultiViewImageFromMultiSweeps', sweeps_num=2),
...
test_pipeline = [
    dict(type='LoadMultiViewImageFromFiles', to_float32=False, color_type='color'),
    dict(type='LoadMultiViewImageFromMultiSweeps', sweeps_num=2, test_mode=True),
...
load_from = 'work_dirs/dd3d_det_final.pth'
work_dir = 'work_dirs/v993ftest'
# resume_from = 'work_dirs/vov99_dd3d_1600x640_3f/epoch_12.pth'
revise_keys = None
