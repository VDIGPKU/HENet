...
train_pipeline = [
    ...
    # new load pipeline
    dict(
        type='LoadAnnotationsBEVDepthLidarPre'), # load point and transform to cam ego; load gt_boxes for ObjectSample(copy paste)
    dict(type='ObjectSample', db_sampler=db_sampler),
    dict(
        type='LoadAnnotationsBEVDepthLidarPost', # geometry data augmentation (trans_xyz for lidar only)
