...
train_pipeline = [
    ...
    dict(type='ImageAug3D', 
        final_dim=(img_scale[1], img_scale[0]), resize_lim=[0.38, 0.55], bot_pct_lim=[0.0, 0.0], rot_lim=[-5.4, 5.4], rand_flip=True, is_train=True),
...
load_from = './work_dirs/DeformFormer3D_L_b4_dynamic/epoch_20.pth'
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 8)
