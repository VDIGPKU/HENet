'''
work_dirs/FocalFormer3D_L_ep6_mAP664_NDS709.pth
'''
...
dataset_type = 'NuScenesDataset_ori'
...
log_level = 'INFO'
work_dir = None
load_from = './work_dirs/DeformFormer3D_L/DeformFormer3D_L_iterimg_ep20_mAP655_NDS707.pth'
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 8)
...
custom_hooks = [dict(type='LidarFadingHook', fade_epoch=1)]
